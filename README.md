...
A CalculaJuros foi construída para ser incrivelmente simples e portátil. Você pode executá-la de duas maneiras, dependendo do seu nível de conforto e ferramentas disponíveis:
...
2. Extraia a pasta `CalculaJuros` (ou o nome que deu ao repositório) no seu computador.
